...
lifespan_by_contri = {0: [], 0.25: [], 0.5: [], 0.75: []}
...
for round in range(num_rounds):
    ...
    for node_id, age in dead_nodes:
        if node_id < n:
            initial_contri = initial_network.nodes[node_id]['contribution']
            lifespan_by_contri[initial_contri].append(age)
...
for contribution, lifespans in lifespan_by_contri.items():
    if lifespans:
